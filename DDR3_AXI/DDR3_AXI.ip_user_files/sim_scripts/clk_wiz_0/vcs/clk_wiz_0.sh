...
#
# Generated by Vivado on Wed Feb 19 09:25:12 +0800 2025
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../DDR3_AXI.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_clk_wiz.v" \
    "$ref_dir/../../../../DDR3_AXI.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0.v" \
  2>&1 | tee -a vlogan.log
